...
- The Google Service Account key was assigned to Play Store submissions and EAS Submit successfully submitted code 17 to the Google Play `alpha` track with release status `COMPLETED`. Submission ID `727907ac-3636-4d7a-9737-6e35ec1c51dc`: https://expo.dev/accounts/kaivenns-team/projects/before-you-order/submissions/727907ac-3636-4d7a-9737-6e35ec1c51dc
